...
syn match  rubyMethodDeclaration   "[^[:space:];#(]\+"	 contained contains=rubyConstant,rubyBoolean,rubyPseudoVariable,rubySelf,rubyInstanceVariable,rubyClassVariable,rubyGlobalVariable
...
syn match   rubyPseudoVariable "\<\%(nil\|__FILE__\|__LINE__\)\>[?!]\@!"
syn match   rubySelf "\<self"
