...
" *** Default Colors *** "
hi Normal                        guifg=#EEEEEC  ctermbg=232  ctermfg=15  cterm=none
hi NonText                       guifg=#729FCF  ctermbg=232  ctermfg=12  cterm=none
...
hi SignColumn                    guifg=#EEEEEC  ctermbg=232  ctermfg=15  cterm=none
hi Directory                     guifg=#729FCF  ctermbg=232  ctermfg=12  cterm=none
hi Title                         guifg=#EEEEEC  ctermbg=232  ctermfg=15  cterm=bold

" *** Syntax Colors *** "
hi Comment                       guifg=#555753  ctermbg=232  ctermfg=8    cterm=none
...
hi SpellRare      guibg=#4A9A06                 ctermbg=2    ctermfg=232
